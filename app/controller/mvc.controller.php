...
{
    function registro(){
        $pagina = $this->load_template('Registro');
        $html   = $this->load_page('app/views/default/modules/m.registro.php');
    ...
    */
    function load_template($title = 'Sin Titulo')
    {
        ...
        $login    = $this->load_page('app/views/default/sections/m.login.php');
        $pagina    = $this->replace_content('/\#LOGIN\#/ms', $login, $pagina);
